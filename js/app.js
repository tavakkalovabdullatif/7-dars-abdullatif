...
function shout(str) {
  // Qichqiring! Lekin faqat kod bilan рџ™ѓ
}
...
function hasValue(arr, value) {
  // Bor yoвЂq, tekshiring... lekin kod bilan рџ”Ќ
}
...
function startsWithA(str) {
  // Harflarning sardori kimligini aniqlang рџ‘‘
}
...
function containsApple(arr) {
  // Meva ichidan olmani toping рџЌЋ
}
...
function getKeys(obj) {
  // Kalitni toping, eshikni oching! рџ—ќпёЏ
}
...
function increaseAge(obj) {
  // Yosh yashiringan, toping va koвЂpaytiring рџ‘¶вћ•
}
